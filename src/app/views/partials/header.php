...
<head>
    ...
    <link rel="icon" type="image/png" href="https://i.imgur.com/Yu2jOZL.png" />
    <style>
        * {
        ...
        <div class="mt-5 container mx-auto">
            ...
            <nav class="mt-2 flex items-center px-4 py-3 bg-indigo-200">
                ...
                <?php if ($logged) : ?>
                    ...
                    <?php else : ?>
                        <a href="/sessions/create" class="ml-auto flex-shrink-0 shadow bg-indigo-600 hover:bg-indigo-500 focus:outline-none text-white font-bold py-3 px-4 rounded">
                            Démarrer une séance
                        </a>
                    <?php endif; ?>
                <?php endif; ?>
